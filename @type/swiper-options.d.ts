import type { A11yOptions } from './modules/a11y.d';
import type { AutoplayOptions } from './modules/autoplay.d';
import type { ControllerOptions } from './modules/controller.d';
import type { CoverflowEffectOptions } from './modules/effect-coverflow.d';
import type { CubeEffectOptions } from './modules/effect-cube.d';
import type { FadeEffectOptions } from './modules/effect-fade.d';
import type { FlipEffectOptions } from './modules/effect-flip.d';
import type { CreativeEffectOptions } from './modules/effect-creative.d';
import type { CardsEffectOptions } from './modules/effect-cards.d';
import type { HashNavigationOptions } from './modules/hash-navigation.d';
import type { HistoryOptions } from './modules/history.d';
import type { KeyboardOptions } from './modules/keyboard.d';
import type { MousewheelOptions } from './modules/mousewheel.d';
import type { NavigationOptions } from './modules/navigation.d';
import type { PaginationOptions } from './modules/pagination.d';
import type { ParallaxOptions } from './modules/parallax.d';
import type { ScrollbarOptions } from './modules/scrollbar.d';
import type { ThumbsOptions } from './modules/thumbs.d';
import type { VirtualOptions } from './modules/virtual.d';
import type { ZoomOptions } from './modules/zoom.d';
import type { FreeModeOptions } from './modules/free-mode.d';
import type { GridOptions } from './modules/grid.d';

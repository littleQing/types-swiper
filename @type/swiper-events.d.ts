...
import type Swiper from './swiper-class.d';

import type { A11yEvents } from './modules/a11y.d';
import type { AutoplayEvents } from './modules/autoplay.d';
import type { ControllerEvents } from './modules/controller.d';
import type { CoverflowEffectEvents } from './modules/effect-coverflow.d';
import type { CubeEffectEvents } from './modules/effect-cube.d';
import type { FadeEffectEvents } from './modules/effect-fade.d';
import type { FlipEffectEvents } from './modules/effect-flip.d';
import type { CreativeEffectEvents } from './modules/effect-creative.d';
import type { CardsEffectEvents } from './modules/effect-cards.d';
import type { HashNavigationEvents } from './modules/hash-navigation.d';
import type { HistoryEvents } from './modules/history.d';
import type { KeyboardEvents } from './modules/keyboard.d';
import type { MousewheelEvents } from './modules/mousewheel.d';
import type { NavigationEvents } from './modules/navigation.d';
import type { PaginationEvents } from './modules/pagination.d';
import type { ParallaxEvents } from './modules/parallax.d';
import type { ScrollbarEvents } from './modules/scrollbar.d';
import type { ThumbsEvents } from './modules/thumbs.d';
import type { VirtualEvents } from './modules/virtual.d';
import type { ZoomEvents } from './modules/zoom.d';
import type { FreeModeEvents } from './modules/free-mode.d';

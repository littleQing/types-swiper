import type { SwiperOptions } from './swiper-options.d';
import type { CSSSelector, SwiperModule } from './shared.d';
import type { SwiperEvents } from './swiper-events.d';

import type { A11yMethods } from './modules/a11y.d';
import type { AutoplayMethods } from './modules/autoplay.d';
import type { ControllerMethods } from './modules/controller.d';
import type { CoverflowEffectMethods } from './modules/effect-coverflow.d';
import type { CubeEffectMethods } from './modules/effect-cube.d';
import type { FadeEffectMethods } from './modules/effect-fade.d';
import type { FlipEffectMethods } from './modules/effect-flip.d';
import type { CreativeEffectMethods } from './modules/effect-creative.d';
import type { CardsEffectMethods } from './modules/effect-cards.d';
import type { HashNavigationMethods } from './modules/hash-navigation.d';
import type { HistoryMethods } from './modules/history.d';
import type { KeyboardMethods } from './modules/keyboard.d';
import type { MousewheelMethods } from './modules/mousewheel.d';
import type { NavigationMethods } from './modules/navigation.d';
import type { PaginationMethods } from './modules/pagination.d';
import type { ParallaxMethods } from './modules/parallax.d';
import type { ScrollbarMethods } from './modules/scrollbar.d';
import type { ThumbsMethods } from './modules/thumbs.d';
import type { VirtualMethods } from './modules/virtual.d';
import type { ZoomMethods } from './modules/zoom.d';
import type { FreeModeMethods } from './modules/free-mode.d';
import type { ManipulationMethods } from './modules/manipulation.d';

...
export { default as Swiper } from './swiper-class.d';
export * from './swiper-events.d';
export * from './swiper-options.d';
export * from './modules/public-api.d';

declare module 'swiper' {
    import Swiper from './types/swiper-class.d'
    import { SwiperOptions } from './types/swiper-options.d'
    import { SwiperModule } from './types/shared.d'
